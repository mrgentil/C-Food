...
const styles = StyleSheet.create({
  ...
  helpButtonText: { fontWeight: '700', fontSize: FONT_SIZES.sm, color: '#ffffff' },
  mapControls: {
    position: 'absolute',
    top: 56,
    right: SPACING.md,
  ...
  liveDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#2c2c2e' },
  liveDotOn: { backgroundColor: COLORS.success },
  liveText: { fontSize: FONT_SIZES.sm, fontWeight: '600', color: '#ffffff' },
  sheet: {
    position: 'absolute',
    bottom: 0,
    left: 0,
  ...
  statusTitle: { fontSize: 22, fontWeight: '800', color: '#ffffff' },
  onTimeBadge: {
  ...
  pickupCardTitle: { fontWeight: '700', fontSize: FONT_SIZES.md, color: '#ffffff', flex: 1 },
  pickupCardTime: { fontSize: FONT_SIZES.sm, color: '#8e8e93' },
  pickupCardSub: { fontSize: FONT_SIZES.sm, color: '#8e8e93' },
  pickupProofImage: {
    width: '100%',
    height: 120,
  ...
  tipBtnText: { fontSize: FONT_SIZES.xs, fontWeight: '700', color: '#ffffff' },
  detailsToggle: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  detailsToggleText: { fontSize: FONT_SIZES.sm, fontWeight: '700', color: '#ffffff' },
  itemLine: { fontSize: FONT_SIZES.sm, color: '#8e8e93', marginTop: 4 },
  trackingBanner: {
    position: 'absolute',
    top: 112,
    left: SPACING.md,
  ...
  trackingBannerTitle: { fontSize: FONT_SIZES.sm, fontWeight: '700', color: '#ffffff' },
  trackingBannerTitleUrgent: { color: '#047857' },
  trackingBannerSub: { fontSize: FONT_SIZES.xs, color: '#8e8e93', marginTop: 2 },
  ...
  addressCalloutText: { fontSize: 11, fontWeight: '600', color: '#ffffff', textAlign: 'center' },
  driverRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: SPACING.sm,
  ...
  driverInfo: { flex: 1 },
  driverName: { fontSize: FONT_SIZES.md, fontWeight: '600', color: '#ffffff' },
  driverSub: { fontSize: FONT_SIZES.sm, color: '#8e8e93' },
  iconBtn: {
    width: 40,
    height: 40,
    borderRadius: 20,
  ...
  itemsTitle: { fontSize: FONT_SIZES.sm, fontWeight: '600', color: '#ffffff' },
  itemsNames: { fontSize: FONT_SIZES.sm, color: '#8e8e93', marginTop: 2 },
  marker: {
    padding: 8,
    borderRadius: 20,
    borderWidth: 2,
